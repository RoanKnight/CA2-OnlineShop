          ...
          <div class="flex">
              ...
              <div class="space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                @if (auth()->user()->hasRole('admin'))
                    ...
                    <!-- If the user is an admin, orders tab will direct you to the admin's order index page-->
                    <x-nav-link :href="route('admin.orders.index')" :active="request()->routeIs('admin.orders.index')">
                      {{ __('Orders') }}
                    </x-nav-link>

                    <!-- If the user is an admin, products tab will direct you to the admin's product index page-->
                    <x-nav-link :href="route('admin.products.index')" :active="request()->routeIs('admin.products.index')">
                      {{ __('Products') }}
                    </x-nav-link>

                    <!-- If the user is an admin, order_products tab will direct you to the admin's order_product index page-->
                    <x-nav-link :href="route('admin.order_products.index')" :active="request()->routeIs('admin.order_products.index')">
                      {{ __('Order_products') }}
                    </x-nav-link>
                @else
