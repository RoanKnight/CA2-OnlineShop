...
class OrderProductController extends Controller
{
  ...
  public function update(Request $request, string $id)
  {
      ...
      $messages = [
        'order_id' => 'The order id is required',
        'product_id' => 'The product id is required',
        'discount_price.regex' => 'The discount price must be in the correct format',
      ];
  ...
  public function destroy(string $id)
  {
      ...
      $order_product->update(['deleted' => true]);
  ...
  public function restore(string $id)
  {
      ...
      // Update the deleted attribute to true
      $order_product->update(['deleted' => false]);

      // Redirect to the product index page with a success message
      return redirect()->route('admin.order_products.index')->with('status', 'Order_product restored successfully');
  }
}