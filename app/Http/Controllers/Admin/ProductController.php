...
class ProductController extends Controller
{
  ...
  public function store(Request $request)
  {
      ...
      // Get the product image from the request
      ...
      // Store the uploaded image in the 'public/images' directory with the generated filename
  ...
  {
      {
      // Validation rules for the updating a product
      $rules = [
